package com.example.pest_detection_app.model
...
object ImageProcessor {
    ...
    fun drawBoundingBoxesOnBitmap(bitmap: Bitmap, boundingBoxes: List<BoundingBox>): Bitmap {
        ...
        fun drawBoundingBoxesOnBitmap1(bitmap: Bitmap, boundingBoxes: List<com.example.pest_detection_app.RoomDatabase.BoundingBox>): Bitmap {
        val mutableBitmap = bitmap.copy(Bitmap.Config.ARGB_8888, true)
        val canvas = Canvas(mutableBitmap)
